...
# m5 = pd.read_csv('RSRP-5.csv', delimiter=',', parse_dates=[0], header=None, names=['x', 'd'])
# m14 = pd.read_csv('RSRP-14.csv', delimiter=',', parse_dates=[0], header=None, names=['x', 'd'])
# m5 = pd.read_csv('SINR-5.csv', delimiter=',', parse_dates=[0], header=None, names=['x', 'd'])
# m14 = pd.read_csv('SINR-14.csv', delimiter=',', parse_dates=[0], header=None, names=['x', 'd'])

m14 = pd.read_csv('snow_data.csv', delimiter=',', parse_dates=[0], header=None, names=['x', 'd'])
...
# plt.plot(m14['x'], m14['d'], label='West Scrafton', kind='bar')

plt.bar(m14['x'], m14['d'], 0.05)
...
# plt.xlabel('Time')
plt.ylabel('Snowfall (mm/3 hours)')
...
#             c = 'black', label = 'min')
# plt.legend(loc='center left', bbox_to_anchor=(0, 0.6), ncol=2)
