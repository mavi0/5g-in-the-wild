...
m5 = pd.read_csv('014-dl.csv', delimiter=',', parse_dates=[0], header=None, names=['x', 'd'])
m14 = pd.read_csv('014-ul.csv', delimiter=',', parse_dates=[0], header=None, names=['x', 'd'])
...
plt.plot(m5['x'], m5['d'], label='Download')
plt.plot(m5['x'], smooth, label='Smoothed')
plt.plot(m14['x'], m14['d'], label='Upload')
...
plt.savefig('014-throughput.png', dpi='figure', format='png', metadata=None,
